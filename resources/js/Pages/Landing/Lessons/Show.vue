<template>
    <div class="px-3 mx-auto max-w-7xl py-5 w-full">
        ...
        <div class="grid md:grid-cols-3 gap-3 ">
            <LessonsList :chapters="course.chapters" :course="course" :locked="!course.is_subscribed"/>
            <div ref="dom" class="md:col-span-2">
                <div
                    v-if="course.chapters && course.chapters[0] && course.chapters[0].lessons && course.chapters[0].lessons[0]"
                    class="font-rabar-022 flex items-center gap-2 text-emerald-950 text-base w-full">
                    <VuePlyr class="w-full h-[70vh]">
                        <div :data-plyr-embed-id="lesson.yt_url" class="w-full h-[70vh]"
