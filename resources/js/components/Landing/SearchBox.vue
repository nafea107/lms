<template>
    <div class="relative  items-center  ">
        ...
        <Input id="search" v-model="searchTerm" :placeholder="$t('بحث...')"
               class="pe-10 py-1 flex items-center bg-gray-100 w-full bg-transparent text-white placeholder:text-white focus-visible:ring-0 "
               type="search"
