...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/nafea/Sites/lms/public/storage' => 'string',
...
'hashing.argon.time','hashing.argon.verify','hashing.rehash_on_login','concurrency.default','view.paths',
...
'filesystems.disks.s3.url','filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links./home/nafea/Sites/lms/public/storage',
...
'session.partitioned','inertia.ssr.enabled','inertia.ssr.url','inertia.testing.ensure_pages_exist','inertia.testing.page_paths',
...
'tinker.dont_alias','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename','ide-helper.include_fluent',
...
'sanctum.csrf-cookie','landing.settings','landing.home',
'landing.search.data','landing.search.show','landing.courses','landing.courses.by-subject','landing.lessons.show',
'landing.courses.show','landing.courses.enroll','landing.quizzes.show','landing.contact.send-email','landing.instructors.index',
'landing.instructors.show','landing.pages.show','landing.favorite-courses.update','admin.home','admin.categories.index',
'admin.categories.data','admin.categories.store','admin.categories.update','admin.categories.destroy','admin.subjects.index',
'admin.subjects.data','admin.subjects.store','admin.subjects.update','admin.subjects.destroy','admin.instructors.index',
'admin.instructors.data','admin.instructors.store','admin.instructors.update','admin.instructors.destroy','admin.levels.index',
'admin.levels.data','admin.levels.store','admin.levels.update','admin.levels.destroy','admin.courses.data',
'admin.courses.index','admin.courses.create','admin.courses.store','admin.courses.show','admin.courses.edit',
'admin.courses.update','admin.courses.destroy','admin.lessons.data','admin.lessons.index','admin.lessons.create',
'admin.lessons.store','admin.lessons.show','admin.lessons.edit','admin.lessons.update','admin.lessons.destroy',
'admin.pages.data','admin.pages.index','admin.pages.create','admin.pages.store','admin.pages.show',
'admin.pages.edit','admin.pages.update','admin.pages.destroy','admin.settings.edit','admin.settings.update',
'admin.profile.edit','admin.enroll-course.index','admin.enroll-course.store','auth-success','register','login','password.request','password.email',
...
'profile.update','profile.destroy','storage.local',);
        registerArgumentsSet('views', 
'app','emails.contact','laravel-exceptions::401','laravel-exceptions::402','laravel-exceptions::403',
...
'validation.uuid','validation.custom.attribute-name.rule-name','validation.password','validation.attributes.name.ar','validation.attributes.name.ku',
'validation.attributes.chapters.*.name.ku','validation.attributes.chapters.*.name.ar','validation.attributes.chapter.*.name.ar','validation.attributes.chapter.*.name.ku','validation.attributes.file',
'validation.attributes.course_id','validation.attributes.chapter_id','validation.attributes.quiz.name.ar','validation.attributes.quiz.name.ku','validation.attributes.quiz.question_and_answers.*.question.ar',
'validation.attributes.quiz.question_and_answers.*.question.ku','validation.attributes.quiz.question_and_answers.*.answers.*.answer.ar','validation.attributes.quiz.question_and_answers.*.answers.*.answer.ku','validation.attributes.quiz.question_and_answers.*.answers.*.is_true','validation.supported',);
